...
class DatabricksAuthentication:
    ...
    def __init__(self) -> None:
        ...
        self.path = (
            os.getenv("DATABRICKS_WAREHOUSE_PATH")
            if "DATABRICKS_WAREHOUSE_PATH" in os.environ
            else "/sql/1.0/warehouses/d1184b8c2a8a87eb"
        )
    ...
    def _get_client(self):
        ...
        if "DATABRICKS_TOKEN" in os.environ:
            ...
            return sql.connect(
                ...
                staging_allowed_local_path=self.tmpdir,
            )
